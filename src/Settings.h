...
public:
  ...
  bool isMessageNotificationsEnabled() const;
  bool isPaymentNotificationsEnabled() const;
#endif

  void setWalletFile(const QString& _file);
  void setEncrypted(bool _encrypted);
  void setReadMessages(const quint16& _read);
  ...
  void setMessageNotificationsEnabled(bool _enable);
  void setPaymentNotificationsEnabled(bool _enable);
#endif
