...
public:
  enum Columns{
    COLUMN_TYPE = 0, COLUMN_DATE, COLUMN_STATE, COLUMN_FROM, COLUMN_TO, COLUMN_HEIGHT, COLUMN_MESSAGE, COLUMN_HASH, COLUMN_AMOUNT, COLUMN_MESSAGE_SIZE,
  ...
  enum Roles {
    ROLE_DATE = Qt::UserRole, ROLE_TYPE, ROLE_HEIGHT, ROLE_MESSAGE, ROLE_FULL_MESSAGE, ROLE_COLUMN, ROLE_ROW,
      ROLE_HASH, ROLE_AMOUNT, ROLE_MESSAGE_SIZE, ROLE_FROM_LABEL, ROLE_FROM_ADDRESS, ROLE_TO_LABEL, ROLE_TO_ADDRESS, ROLE_STATE
  };

  static const QString HEADER_FROM_KEY;
  static const QString HEADER_TTL_KEY;
