...
Q_DECL_CONSTEXPR quint64 COMMENT_CHAR_PRICE = UINT64_C(100);
...
void SendFrame::addRecipientClicked() {
  ...
  newTransfer->setCompleter(ModelCompleter);
...
void SendFrame::sendClicked() {
  ...
  if (WalletAdapter::instance().isOpen()) {
    WalletAdapter::instance().sendTransaction(walletTransfers, fee, nullptr, 0, walletMessages);
  }
}
