...
*/
  ...
  //m_ui->m_messagesView->setSelectionMode(QAbstractItemView::NoSelection);
  //m_ui->m_messagesView->setFocusPolicy(Qt::NoFocus);

  m_ui->m_transactionsView->horizontalHeader()->setStretchLastSection(true);
  m_ui->m_transactionsView->horizontalHeader()->setSectionResizeMode(QHeaderView::ResizeToContents);
  m_ui->m_transactionsView->horizontalHeader()->setHighlightSections(false);
  m_ui->m_transactionsView->verticalHeader()->hide();
  m_ui->m_transactionsView->resizeColumnsToContents();
