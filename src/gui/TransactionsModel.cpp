...
QVariant TransactionsModel::getDecorationRole(const QModelIndex& _index) const {
  if(_index.column() == COLUMN_STATE) {
    if (_index.data(ROLE_FEE).toULongLong() == 0 && _index.data(ROLE_TYPE).value<quint8>() != static_cast<quint8>(TransactionType::MINED)) {
      return QPixmap(":icons/tx-message").scaled(20, 20, Qt::IgnoreAspectRatio, Qt::SmoothTransformation);
    }

    quint64 numberOfConfirmations = _index.data(ROLE_NUMBER_OF_CONFIRMATIONS).value<quint64>();
    switch (numberOfConfirmations) {
    case 0:
      return QPixmap(":icons/clock0").scaled(20, 20, Qt::IgnoreAspectRatio, Qt::SmoothTransformation);
    case 1:
      return QPixmap(":icons/clock1").scaled(20, 20, Qt::IgnoreAspectRatio, Qt::SmoothTransformation);
    case 2:
      return QPixmap(":icons/clock2").scaled(20, 20, Qt::IgnoreAspectRatio, Qt::SmoothTransformation);
    case 3:
      return QPixmap(":icons/clock3").scaled(20, 20, Qt::IgnoreAspectRatio, Qt::SmoothTransformation);
    case 4:
      return QPixmap(":icons/clock4").scaled(20, 20, Qt::IgnoreAspectRatio, Qt::SmoothTransformation);
    case 5:
      return QPixmap(":icons/clock5").scaled(20, 20, Qt::IgnoreAspectRatio, Qt::SmoothTransformation);
    case 6:
      return QPixmap(":icons/clock6").scaled(20, 20, Qt::IgnoreAspectRatio, Qt::SmoothTransformation);
    case 7:
      return QPixmap(":icons/clock7").scaled(20, 20, Qt::IgnoreAspectRatio, Qt::SmoothTransformation);
    case 8:
      return QPixmap(":icons/clock8").scaled(20, 20, Qt::IgnoreAspectRatio, Qt::SmoothTransformation);
    case 9:
      return QPixmap(":icons/clock9").scaled(20, 20, Qt::IgnoreAspectRatio, Qt::SmoothTransformation);
    case 10:
      return QPixmap(":icons/clock10").scaled(20, 20, Qt::IgnoreAspectRatio, Qt::SmoothTransformation);
    case 11:
      return QPixmap(":icons/clock11").scaled(20, 20, Qt::IgnoreAspectRatio, Qt::SmoothTransformation);
    default:
      return QPixmap(":icons/transaction").scaled(20, 20, Qt::IgnoreAspectRatio, Qt::SmoothTransformation);
    }
