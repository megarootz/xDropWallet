...
public:
  enum Columns {
    COLUMN_STATE = 0, COLUMN_STATUS, COLUMN_DATE, COLUMN_AMOUNT, COLUMN_ADDRESS, COLUMN_MESSAGE, COLUMN_PAYMENT_ID, COLUMN_HASH, COLUMN_FEE,
  ...
  enum Roles {
    ...
    ROLE_MESSAGES, ROLE_DEPOSIT_ID, ROLE_DEPOSIT_COUNT, ROLE_STATE
  };
