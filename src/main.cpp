...
int main(int argc, char* argv[]) {
  ...
  app.setApplicationName("xdropwallet");
  ...
  splash->showMessage(QObject::tr(" "), Qt::AlignLeft | Qt::AlignBottom, Qt::black);
  app.processEvents();
...
//  QPixmap pixmap = QPixmap(":/images/logo-ico");
//  QIcon ButtonIcon(pixmap);
//  app.setWindowIcon(ButtonIcon);
